...
function signature(x, y, size) {
    ...
    context.fillRect(x + 600, y + 350, size, size);
    context.fillRect(x + 650, y + 350, size, size);

    context.fillRect(x + 550, y + 400, size, size);
    context.fillRect(x + 600, y + 400, size, size);
    
    context.fillRect(x + 500, y + 350, size, size);
    context.fillRect(x + 450, y + 350, size, size);
    context.fillRect(x + 500, y + 400, size, size);
    context.fillRect(x + 500, y + 450, size, size);
    context.fillRect(x + 450, y + 450, size, size);
    context.fillRect(x + 550, y + 450, size, size);
    context.fillRect(x + 600, y + 450, size, size);
    context.fillRect(x + 650, y + 450, size, size);
